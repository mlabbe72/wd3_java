...
/**
 * This class holds various methods for the Robot class
 * 
 * @author mlabbe
 *
 */
public class RobotUtils extends Robot {
	...
	public RobotUtils(WebDriver driver) throws Exception {
		this.driver = driver;
		this.robot = new Robot();
	}
	
	/**
	 * Use this method for key combinations to hold/release together
	 * Example: ctrl-alt-del
	 * 
	 * @param keys: Pass in list as {KeyEvent.VK_CONTROL, keyEvent.VK_ALT} 
	 */
	public void pressComboKeys(int[] keys) {
		// Press them all
	...
	/**
	 * Use this method for entering text
	 * @param characters
	 * 		characters to type
	 */
	public void type(CharSequence characters) {
		...
		for(int i = 0; i < length; i++) {
			...
			internalType(character);
		}
	}
	
	/*
	 * Switch to execute a particular key
	 */
	private void internalType(char character) {
		 switch (character) {
	        ...
	        case '^': doType(KeyEvent.VK_CONTROL); break; // hijacked "^" for CONTROL key
